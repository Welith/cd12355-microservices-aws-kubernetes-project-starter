...
# ECR Repositories
###################
resource "aws_ecr_repository" "coworking" {
  name                 = "coworking"
...
data "aws_iam_policy_document" "codebuild_ecr_policy" {
  ...
  statement {
    ...
    resources = [
      aws_ecr_repository.coworking.arn
    ]
  }
}
...
resource "aws_codebuild_project" "codebuild" {
  ...
  source {
    type            = "GITHUB"
    location        = "https://github.com/Welith/cd12355-microservices-aws-kubernetes-project-starter"
    git_clone_depth = 1
